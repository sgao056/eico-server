...
// const serverUrl = "https://0cxgpueuzfrk.usemoralis.com:2053/server";
// const appId = "hvnPWjSjn0uCGWIEABxF27REOrNrdfMmrHqqwYXh";
// const moralisSecret = "GpS5pM3SIDdtylsqTZVWGqV72UtUtoja9F0KEcv0SbZuDRkfH0dHrgpbLw7XGbQw";
...
app.get("/secret", async (req, res)=>{
  ...
  let balance = Number(await contract.methods.balanceOf(address,1).call())
  console.log(balance)
